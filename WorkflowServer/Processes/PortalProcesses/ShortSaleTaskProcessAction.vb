...
Public Class ShortSaleTaskProcessAction
...
#Region "Event Rules"
    ...
    Public Shared Sub ManagerApproval(ByRef evtInst As EventInstance)
        evtInst.ItemData = String.Format("/Shortsale/ShortSale.aspx?sn={0}", evtInst.ClientSeriesNumber)
    ...
    Private Shared Sub NotifyUser(evtInst As EventInstance)
        ...
        Using client As New CommonService.CommonServiceClient
            For Each user In evtInst.ActivityInstance.DestinationUsers
                ...
                emailData.Add("TaskComments", evtInst.ProcessInstance.GetDataFieldValue("TaskId").ToString)
                client.SendEmailByTemplate(user, "NewShortSaleTaskNotification", emailData)
            Next
        End Using
    End Sub
#End Region
